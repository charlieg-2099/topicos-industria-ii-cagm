...
Jobs Ejecutados: 1,486 de 1,486
                 (100% éxito)

CPU Usage:       70% promedio
                 (2 cores utilizados)

Throughput:      ~52 seg/archivo
                 (Box 4 dominante)
```
...
### 🎯 Resultados de Ejecución Completa (300 archivos)

| Métrica | Valor |
|---------|-------|
| **Jobs Ejecutados** | 1,486/1,486 (100%) |
| **Tiempo Total** | 4h 20min 2seg |
| **Archivos Generados** | 1,800 (300 × 6 etapas) |
| **Fallos** | 0 |
...
### 📈 Desglose de Tiempo Real (300 Archivos)
...
#### ⏱️ Tiempo por Etapa
```
Caja 4 (ROOT):     ~3.6 horas (83%)
Caja 5 (NPZ):      ~10 minutos (4%)
Caja 6 (IMG):      ~2.5 minutos (1%)
Caja 8 (ML_NPZ):   ~10 minutos (4%)
Caja 9 (HDF5):     ~2.5 minutos (1%)
Overhead:          ~30 minutos (7%)
────────────────────────────────
Total Real:        4h 20min 2seg
```
...
> ⚠️ **Nota:** Diferencia debido a:
> - Emulación x86_64 en ARM64 (overhead ~20-30%)
> - Configuración conservadora: 2 cores vs 8+ cores
> - Box 4 (WCSim) es intensivo en CPU (~52 seg/archivo)
...
Todas las capturas de pantalla de la ejecución real están disponibles en:
**[`screenshots/`](screenshots/)** - 20 imágenes de evidencia

#### 📂 Organización de Screenshots:

| Categoría | Archivos | Descripción |
|-----------|----------|-------------|
| **Inicio del Pipeline** | `02_inicio_pipeline*.png` | Building DAG, Job stats (1,501 jobs) |
| **Progreso** | `03_progreso*.png` | Ejecución en tiempo real |
| **Finalización** | `04_finalizacion*.png` | Completado con tiempo total |
| **Verificación** | `05_verificacion*.png` | Conteo de archivos generados |
| **Extras** | `image (XX).png` | Evidencias adicionales |

### 🚀 Resumen de Ejecución (Datos Reales)
...
[Durante 4h 20min] ⚙️  PROCESANDO
Execute jobs in parallel (2 cores)...
├─ Box 4 (MAC→ROOT):      300/300 ✓
├─ Box 5 (ROOT→NPZ):      300/300 ✓
├─ Box 6 (NPZ→IMG):       300/300 ✓
├─ Box 8 (ROOT→ML_NPZ):   300/300 ✓
└─ Box 9 (NPZ→HDF5):      300/300 ✓

[Fri May 1 01:20:12 2026] ✅ COMPLETADO
1,486 of 1,486 steps (100%) done
Time: 4h 20min 2seg
